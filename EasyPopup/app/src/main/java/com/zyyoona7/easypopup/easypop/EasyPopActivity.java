...
public class EasyPopActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void handleLogic(View contentView) {
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EasyPopActivity.this, showContent, Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void initQQPop() {
        //View contentView = LayoutInflater.from(this).inflate(R.layout.layout_right_pop, null);
...
//                .setDimView(mTitleBar)
    ...
    private void initWeiboPop() {
        //View contentView = LayoutInflater.from(this).inflate(R.layout.layout_center_pop, null);
        //handleLogic(contentView);
