...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    private PopupWindow build() {
        ...
        if (mWidth != 0 && mHeight != 0) {
            Log.d(TAG, "build:: mWidth:" + mWidth + ",mHeight:" + mHeight);
            mPopupWindow = new PopupWindow(mContentView, mWidth, mHeight);
        } else if (mWidth != 0 && mHeight == 0) {
            Log.d(TAG, "build:: mWidth:" + mWidth + ",WRAP_CONTENT mHeight:" + mHeight);
            mPopupWindow = new PopupWindow(mContentView, mWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        } else if (mWidth == 0 && mHeight != 0) {
            Log.d(TAG, "build:: WRAP_CONTENT mWidth:" + mWidth + ",WRAP_CONTENT mHeight:" + mHeight);
